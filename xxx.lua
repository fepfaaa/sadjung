...
function create:Win()
    ...
    Logo.Image = "http://www.roblox.com/asset/?id=8699346984"
    ...
    UIGradient_PageTap.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 255, 255))}
...
function tap:addtap(text)
    ...
    TextLabel_Tap.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
...
function ems:Button(text,callback)
    ...
    MheeFrameStroke.Color = Color3.fromRGB(0, 255, 255)
...
function ems:Button1(text,callback)
    ...
    ToggleFrame1.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
...
function  ems:Toggle(text,de,callback)
    ...
    ImageLabel_Toggle.Image = "rbxassetid://8691483767"
...
function ems:DropDown(text,text2,list,callback)
    ...
    TextLabelDrop.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
    ...
    TextLabelDrop2.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
...
function ems:Slder(text,min,max,de,callback)
    ...
    SlisFrameStroke.Color = Color3.fromRGB(0, 255, 255)
    ...
    TalabelSlider.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
    ...
    MainValue.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
...
function ems:Ti(text)
    ...
    lineframe2.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
